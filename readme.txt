...
1) Download the standalone application Ubuntu>=20 (size>5GB) with all library: https://drive.google.com/file/d/1fH99dmt4HI75x02RpdoB7tSh0PMRDfko/view?usp=sharing
2) Tutorial
3) Source code model